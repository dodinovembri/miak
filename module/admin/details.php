      ...
      <div class="row">
        <div class="span12">
        	...
        	<!-- awal -->
              ...
              $query = mysqli_query($koneksi, "SELECT trx_bk.*, barang_tersedia.*, bahan_baku.* from trx_bk JOIN barang_tersedia ON trx_bk.pesanan = barang_tersedia.id_barang_tersedia JOIN bahan_baku ON trx_bk.bahan = bahan_baku.id_bahan_baku where trx_bk.id_trx_pelanggan = $id_detail");
