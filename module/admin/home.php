      ...
      <div class="row">
        <div class="span6">
          <div class="widget widget-nopad">
            ...
            <!-- /widget-header -->
            <?php include 'module/koneksi.php'; 
              $q = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM orderan_untuk_supplier WHERE status='B'");
              while ($r = mysqli_fetch_array($q)) {
                $jumlah = $r['jumlah'];
              }

              $qu = mysqli_query($koneksi, "SELECT COUNT(*) AS jumlah FROM orderan_untuk_supplier WHERE status='P'");
            ...
            <div class="widget-content">
              <div class="widget big-stats-container">
                <div class="widget-content">
                  <h6 class="bigstats">Status <a href="#" target="_blank">Surya Bakery</a> Hari Ini</h6>
                  <div id="big_stats" class="cf">
                    <!-- <div class="stat"> <i class="fas fa-user-tag"></i> <span class="value">851</span> </div> -->
                    <!-- .stat -->
                    
                    <div class="stat"> <a href="?module=barang_yang_akan_diorder"><i class="fas fa-list-alt"></i></a> <span class="value"><?php echo $jumlah; ?></span><br>Pesanan Ke Suplier </div>
                    <!-- .stat -->
                    
                    <div class="stat"> <a href="?module=barang"><i class="fas fa-cart-arrow-down"></i></a> <span class="value"><?php echo $jumlah2; ?></span> <br>Barang Masuk</div>
                    <!-- .stat -->
